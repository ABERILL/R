...
campaign_data <- read.csv('R/final/campaign_desc.csv')
transaction_data <- read.csv('R/final/transaction_data.csv')
customer_data <- read.csv('R/final/hh_demographic.csv')
